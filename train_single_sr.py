...
for epoch in range(num_epochs):
    for i, data in enumerate(dataloader):
        ...
        if not ran_once:
            ...
            with torch.no_grad():
                penalty_baseline = calculate_baseline(data.edge_index, data.edge_attr, data.batch, batch_size, distance_matrix, samples)
...
fig.savefig('plots/loss_list_pre_sr.png', dpi=300)
